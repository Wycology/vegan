...
We can go ahea calculate species diversity in the 50 plots using **shannon** index. There are also indices like **simpson** or **invsimpson** that one can calculate from the data-set.
