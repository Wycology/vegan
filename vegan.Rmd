...
This has two separate data-frames, one for species per plot and the other for the environmental variables re from the same sampling plots as the species.
