...
We can have the `specnumber(BCI)` converted into  daf and arranged to know which sampling plot had the highest number of species.
...
Assessing the rlationship between shannon and invsimpson indices of diversity.
