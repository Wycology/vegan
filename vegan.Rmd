...
In this write-up I explored `vegan` package. `vegan` is an `R` library featuring a number of relevant functions. Here I demonstrate some use cases.
...
The other way of getting the number of species from plot in the data-set is to use `specnumber()`.
