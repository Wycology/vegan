...
I explore `vegan`. `vegan` is an R package that features in day to day working of a community ecologist. It would be great to know a few cases where the package comes in handy.
...
This has two separate dataf-rames, one for species per plot and the other for the environmental variables observed from the same sampling plots as the species.
