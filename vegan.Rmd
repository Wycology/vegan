...
It is possible to estimate the number of species in the pool using `specpool()` function in `R`. So,ctually, there are 225 species, but the estimator gives values from 236 to 247 with some standard errors.
