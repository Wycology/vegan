...
In this write-up I explored `vegan` package. `vegan` is an `R` library featuring a number of important functions. Here I demonstrate some use cases.
...
These are further plots that can be created to show relationships within the data-set.
