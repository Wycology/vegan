...
Here I take a look at `vegan`. `vegan` is an R package th features in day to day working of a community ecologist. It would be great to know a few cases where the package comes in handy.
