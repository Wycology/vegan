...
I explore the `vegan` package. `vegan` is an `R` library that features a number of community ecology relevant functions. Here I demonstrate some use cases.
...
We can have the `specnumber(BCI)` converted into a data frame and arranged to know which sampling plot had the highest number of species.
...
Here is a data-set of 50 plots indicating number of individuals of species of trees counted in each sampling plot. Typical ecological survey work.
...
Calculating the `metaMDS` on the data. It is important to look into what these functions do and how to interpret their meanings.
