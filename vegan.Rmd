...
I explore the `vegan` package. `vegan` is an R library that features a number of community ecology relevant functions. It would be great to know a few cases where the package comes in handy.
