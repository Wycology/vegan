...
This has two separate data-frames, one for species per plot and the other for the environmental variables ob from the same sampling plots as the species.
