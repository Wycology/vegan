...
This has two separate dataframes, one for species per plot and the other for the environemntal variables observed from the same sampling plots as the species.
