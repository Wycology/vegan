...
Seems there are a lot of data here, we can check the dimensions of the dataframe using the `dim` function from base `R` package.

```{r}
dim(BCI)
```

Another way to obtain the number of species in the data-set is to use `specnumber()` function.
