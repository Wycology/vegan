...
In this write-up I explore `vegan` package. `vegan` is an `R` library that features a number of c ecology relevant functions. Here I demonstrate some use case.
