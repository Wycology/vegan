...
We can convert the `specnumber(BCI)` into a df and arranged to show which sampling plot had the highest number of species and which had the least.
...
Here we explore a data-set consisting of 50 field plots showing the number of individuals of species of trees counted in each sampling plot. Typical ecological survey work.
